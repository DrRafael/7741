...
Эта программа предназначена для генерации случайных паролей с заданным количеством символов. Пароли могут содержать буквы верхнего и нижнего регистра, цифры и специальные символы. Она пригодится если вы не хотите сильно заморачиватся с созданием паролей для своих нужд
